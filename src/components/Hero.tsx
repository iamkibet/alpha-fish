    ...
    <section id="home" className="relative">
      <div className="mx-auto max-w-[1400px]">
        <div className="grid lg:grid-cols-2">
          ...
          <div className="bg-gradient-to-br from-[#1375bc] via-[#0f5d94] to-[#0a4a75] flex items-center justify-center px-8 sm:px-12 lg:px-16 py-12 lg:py-16 min-h-[400px] lg:min-h-[500px] relative overflow-hidden">
            ...
            <div className="max-w-2xl relative z-10">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                Frozen and Chilled{" "}
                <span className="block">Fish Products</span>
              </h1>
              
              <p className="text-lg sm:text-xl text-white/90 leading-relaxed mb-8 max-w-xl">
                Welcome to Alpha Fish, your trusted partner in premium frozen and chilled fish products. 
                We are committed to supplying high-quality, sustainably sourced seafood that meets the 
